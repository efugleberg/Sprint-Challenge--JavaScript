...
// Explanation: 
//  ------> MY ANSWER <-------
//  Nestedfunction() can access the variable 'internal' because it is inside the closure of the variable 
//  'internal'.  Things inside the closure can access all other items inside of the closure and those 
